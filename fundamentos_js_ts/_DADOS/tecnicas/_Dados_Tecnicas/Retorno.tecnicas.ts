...
const retorno_tecnicas = [
  {
    ...
    4. será guardado o que deseja usar da funcaoPromessa no test - desencadear .then() para guardar o sucesso || ou desencadear .catch() para guardar a falha com o feedback ..DAI SÓ TESTAR O GUARDADO.
    `,
    observacoes: `
    // EXEMPLOS
